 ...
 */
function pfInlet($pfTemplatePath, $pfModelData, $delimiter = '`') {
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <script type="text/javascript">
     ...
     */
    var pfTemplatePath = "<?php echo $pfTemplatePath; ?>";
  </script>
  ...
  <script type="text/javascript">
     ...
     * assign modeldata
     */
    var pfModelData = <?php echo $delimiter . $pfModelData . $delimiter; ?>;
  </script>
